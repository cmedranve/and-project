...
class ComposerOfNavigationButtonContinue(
    ...
    fun composeUiData(
        ...
        val adapterFactory: AdapterFactoryOfNavigationButtonContinue<Any> = AdapterFactoryOfNavigationButtonContinue()
    ...
    override fun editNavigationButtonContinueEnabling(id: Long, isEnabled: Boolean) {
    ...
    override fun editNavigationButtonContinueText(id: Long, text: CharSequence) {
        val entity: UiEntityOfNavigationButton<Any> = itemEntities
            .firstOrNull { entity -> id == entity.id }
            ?: return
    ...
    override fun removeNavigationButtonContinue(id: Long) {
