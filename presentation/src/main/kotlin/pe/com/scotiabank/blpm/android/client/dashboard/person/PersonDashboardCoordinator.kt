...
class PersonDashboardCoordinator(
    ...
    private val navigationComposite: NavigationComposite = factoryOfNavigationComposite
        .create(
            ...
            visibilitySupplier = visibilitySupplerForNavigation
        )
    ...
    private fun setUpBottomNavigationBar() {
        ...
        PersonNavigationItem.entries.map {
            navigationItem: PersonNavigationItem ->
    ...
    private fun addMenuItemByTemplate(featureTemplate: FeatureTemplate, item: PersonNavigationItem) {
    ...
    private fun getCoordinatorByIdItem(
        item: PersonNavigationItem,
    ): Supplier<Coordinator> = when(item) {
        PersonNavigationItem.PLIN -> Supplier(homeFactory::create)
        PersonNavigationItem.MY_ACCOUNT -> Supplier(homeFactory::create)
        PersonNavigationItem.NOTIFICACIONS -> Supplier(homeFactory::create)
        PersonNavigationItem.MY_LIST -> Supplier(homeFactory::create)
    ...
    private fun getCoordinatorIdByItem(
        ...
        PersonNavigationItem.PLIN -> idRegistry.coordinatorIdOfP2p
        PersonNavigationItem.MY_ACCOUNT -> idRegistry.coordinatorIdOfManagementCenter
        PersonNavigationItem.NOTIFICACIONS -> idRegistry.coordinatorIdOfNews
        PersonNavigationItem.MY_LIST -> idRegistry.coordinatorIdOfMyList
