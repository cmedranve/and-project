...
class FrequentFactoryForTransferOtherAccount: FrequentFactory<TransferSummaryModel> {
    ...
    override fun create(
        ...
        transferAttributeEntity.accountType = summary.accountType
        ...
        transferAttributeEntity.creditAccountType = summary.creditAccountType
