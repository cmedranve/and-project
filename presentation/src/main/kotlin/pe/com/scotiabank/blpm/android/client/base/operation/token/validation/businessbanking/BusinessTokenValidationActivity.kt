...
import pe.com.scotiabank.blpm.android.client.databinding.ActivityBusinessTokenValidationBinding
...
class BusinessTokenValidationActivity : BaseBindingActivity<ActivityBusinessTokenValidationBinding>() {
    ...
    private val handlingStore: HandlingStore = HandlingStore.Builder()
        .add(
            ...
            InstanceHandler(::onShowOtpMessage)
        )
        .add(
    ...
    override fun getBindingInflater(): BindingInflaterOfActivity<ActivityBusinessTokenValidationBinding> {
        return BindingInflaterOfActivity(ActivityBusinessTokenValidationBinding::inflate)
    }
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onSmartTokenEntered(p0: View?, p1: CharSequence?, p2: Int, p3: Int, p4: Int) {
        viewModel.postEnablingOfConfirmButton(binding.cc.isDigitalKeyValid)
    }
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onShowOtpMessage(intention: ValidationIntention) {
    ...
    private fun onConfirmClicked(view: View) {
        viewModel.onConfirmClicked(binding.cc.digitalKey, binding.cc.operationDescription)
    }
