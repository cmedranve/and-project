...
class ComposerOfCheckableTransfer(
    ...
    private val converter: ConverterForCheckableTransfer = ConverterForCheckableTransfer(
    ...
    private fun toUiEntityOfCheckBox(
        ...
        return converter.toUiEntityOfCheckBox(frequentOperation, id)
    }
