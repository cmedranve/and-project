...
class BusinessDashboardCoordinatorFactory(
    private val hub: Hub,
    ...
    private fun createFactoryForNavigationComposite(idRegistry: IdRegistry) = NavigationComposite.Factory(
        dispatcherProvider = hub.dispatcherProvider,
    ...
    private fun createVisitRegistry(idRegistry: IdRegistry): VisitRegistry {
        val maxNumberAllowedById: Map<Long, Int> = mapOf(
            ...
            idRegistry.coordinatorIdOfDashboard to 1,
            idRegistry.coordinatorIdOfScotiaPay to 1,
