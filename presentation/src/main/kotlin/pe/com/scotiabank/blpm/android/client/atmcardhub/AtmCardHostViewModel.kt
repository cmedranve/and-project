    ...
    HolderOfInstanceFlow
{
    ...
    private val atmCardHubFlowFactory: AtmCardFlowCoordinatorFactory by lazy {
        AtmCardFlowCoordinatorFactory(hub, appModel.sessionRetrofit, viewModelScope, weakSelf)
    }
    ...
    private fun onScreenCreated() = viewModelScope.launch {
        ...
        val child: Coordinator = atmCardHubFlowFactory.create(isDeepLink)
