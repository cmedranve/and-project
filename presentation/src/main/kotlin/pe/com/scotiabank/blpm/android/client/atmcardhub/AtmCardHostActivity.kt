...
import pe.com.scotiabank.blpm.android.client.host.shared.PermissionRequestHolder
...
class AtmCardHostActivity: BaseBindingActivity<ActivityPortableHostBinding>() {

    private val creationExtras = MutableCreationExtras()

    @Inject
    lateinit var viewModelFactory: ViewModelFactory
    private val viewModel: AtmCardHostViewModel by viewModels(
