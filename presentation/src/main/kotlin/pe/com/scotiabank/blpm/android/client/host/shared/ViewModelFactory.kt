...
class ViewModelFactory @Inject constructor(
    ...
    private val proxyOfErrorInterceptor: ProxyOfErrorInterceptor,
    private val factoryOfOkHttpClient: FactoryOfOkHttpClient,
    ...
    private fun createViewModel(extras: CreationExtras): HostViewModel = HostViewModel(
    ...
    private fun createVisitRegistry(): VisitRegistry {
        val maxNumberAllowedById: Map<Long, Int> = mapOf(
            HostViewModel.HOST_ID_FOR_VISIT_REGISTRY to 1,
        )
    ...
    private fun createOkHttpClient(): OkHttpClient = factoryOfOkHttpClient.create(
        appContext = appContext,
        proxyOfErrorInterceptor = proxyOfErrorInterceptor,
        cookieJar = FactoryOfCookieJar.createCookieJar(cookieRepository),
    )
}