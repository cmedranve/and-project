...
class TextCollectorForTransferEmptyState(
    ...
    override fun collect(): List<UiEntityOfOneColumnText> {
        ...
        val descriptionEntityForTop = UiEntityOfOneColumnText(
            ...
            entityOfColumn = createEntityOfDescriptionText(R.string.my_list_empty_transfer_description_1),
        )

        val descriptionEntityForBottom = UiEntityOfOneColumnText(
            paddingEntity = paddingEntityForBottom,
            entityOfColumn = createEntityOfDescriptionText(R.string.my_list_empty_transfer_description_2),
        )
